...
-(void)commonInit{
    ...
    lineColor=[UIColor colorWithRed:1 green:1 blue:1 alpha:1.000];//[UIColor colorWithRed:0.482 green:0.854 blue:0.870 alpha:1.000];
              ...
              initialSpringVelocity:velocity
                            options:UIViewAnimationOptionCurveEaseInOut animations:^{
                                ...
                                if (self.text.length<=0) {
                                    ...
                                    UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad ? [placeHolderLabel setFont: [UIFont systemFontOfSize:14.0]] : [placeHolderLabel setFont: [UIFont systemFontOfSize:10.0]];
                                    //                                    [placeHolderLabel setFont: [UIFont systemFontOfSize:14.0]];
                                    //                                    placeHolderLabel.transform=CGAffineTransformMakeTranslation(1, -placeHolderLabel.frame.size.height+4);
                                    placeHolderLabel.frame = CGRectMake(0, -8, placeHolderLabel.frame.size.width+20, placeHolderLabel.frame.size.height);
                                }
                            }
